...
### 8 水平ロータリーエンコーダのはんだ付け

The cool642tb_r3 can be fitted with a dedicated horizontal rotary encoder.
<br>
cool642tb_r3では、専用の水平ロータリーエンコーダが取り付け可能です。
<br>
Similar to a vertical rotary encoder, it is inserted from the front of the PCB and soldered on the back.
<br>
垂直ロータリーエンコーダと同じように、PCB表面から差し込んで、裏面ではんだ付けをします。
<br>
The PCB in version 1.01 supports not only the dedicated horizontal rotary encoder, but also the [CKW12] (https://shop.yushakobo.jp/products/ckw12) sold by Yushakobo.
<br>
ver.1.01のPCBでは、専用の水平ロータリーエンコーダだけでなく、遊舎工房で販売されている[CKW12](https://shop.yushakobo.jp/products/ckw12)にも対応しています。
<br>
...
<br>
上からスイッチプレート、PCBの順番で重ねて、上からM2 6mmネジを４本差し込みます。
<br>
Insert the nut into the bottom of the bottom case, then tighten the screw inserted from above to secure it.
<br>
ボトムケースの下側にナットを入れて、上から差し込んだネジを回して固定します。
<br>
...
Plug your favorite key switch into the one you made in section 9.
<br>
...
<br>
セクション9で作ったものに、自分のお気に入りのキースイッチを差し込みます。
<br>
...
<br>
Insert two M2 6mm screws from the inside of the ball case and secure them by placing nuts on the bottom of the ball case.
<br>

<br>
トラックボール基板をキーボード基板の右手側にあるL字コンスルーの7ピンに合うように取り付けます。
<br>
ボールケースの内側から2箇所、M2 6mmネジを差し込み、ボールケース底面にナットを入れて固定します。
<br> 
<br>
...
<br>
If you want the ball to spin even better, use a ball case with bearings. Use M2 6mm screws to secure the bearings.
<br>
さらによりよくボールを回したいと考えるならば、ベアリング採用のボールケースを使用してください。ベアリングの固定には、M2 6mmネジを使用してください。
<br>
...
<br>
電池ケースカバーにインサートナットを熱封入します。
<br>
次の動画を参考にしてください。

https://www.youtube.com/watch?v=SEss5_TtFUM

<br>
The battery case cover is secured by inserting an M2 6mm screw from the bottom of the bottom case.
<br>
電池ケースカバーは、ボトムケースの底面から、M2 6mmネジを差し込んで、固定します。
<br>
